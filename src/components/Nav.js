                ...
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <Link to="/">
                        <div className="flex">
                            ...
                            <span className="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Poker Next</span>
                        </div>
                    </Link>
